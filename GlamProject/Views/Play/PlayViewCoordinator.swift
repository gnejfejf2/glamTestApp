...
protocol PlayTabCoordinatorProtocol {
//    func simpleViewOpen()
}

class PlayViewCoordinator : TabViewCoordinator , PlayTabCoordinatorProtocol {
    ...
    func start() {
        ...
        let viewModel = PlayViewModel(coordinator:  self)
